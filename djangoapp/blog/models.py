...
class Page(models.Model):
    ...
    is_published = models.BooleanField(
        default=False,
        help_text="This page will be visible to everyone if checked.",
    )
...
class Post(models.Model):
    ...
    is_published = models.BooleanField(
        default=False,
        help_text="This post will be visible to everyone if checked.",
    )
    content = models.TextField()
    ...
    cover_in_post_content = models.BooleanField(
        default=True,
        help_text="If checked, the cover image will also appear in the post content.",
    )
